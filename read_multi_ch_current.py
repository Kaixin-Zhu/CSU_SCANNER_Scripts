...
def main(ep, afe, ch_list, run_type, run_id):
    afe = int(afe)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--ch', type=lambda s: [int(item) for item in s.split(',')], required=True, help='Comma-separated channels list, e.g. 0,2,5,7')
